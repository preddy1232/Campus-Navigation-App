...
public class BaseGraph<NodeType, EdgeType extends Number> {
    ...
    private List<NodeType> allNodeKeys = new ArrayList<>();
    ...
    /**
     * Retrieves a list of all node data (locations) from the graph.
     * @return a list of all node data present in the graph
     */
    public List<NodeType> getAllLocations() {
        return new ArrayList<>(allNodeKeys);
    }
